...
import com.accidentaldeveloper.yourprofile.databinding.ActivityMain6Binding;
import java.io.File;
...
public class MainActivity6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.share12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Share the image
                Bitmap image = getBitmapFromView(binding.Aryann);
    ...
    public void jump6(View view) {
        Intent jump6 = new Intent(this,MainActivity.class);
        startActivity(jump6);
    }
}